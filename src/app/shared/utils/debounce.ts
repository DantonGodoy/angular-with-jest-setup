...
export class Debounce {
  public static debounce(func: Function, wait: number, immediate: string) {
    let timeout;
    ...
    return function executedFunction() {
      ...
      // This is the step that prevents the function from being executed because it will
      // never reach the inside of the previous setTimeout.
